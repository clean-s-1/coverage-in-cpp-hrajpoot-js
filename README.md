...
**1. I'll apply the learning in project's pull request while reviewing them.
**2. Knowledge sharing among the teammates by giving them feedback.
**3. Refactoring the code until it is not impacting the estimation
